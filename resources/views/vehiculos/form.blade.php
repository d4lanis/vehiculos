<div class="form-group">
    ...
    <select name="subMarca_id" id="subMarca_id" class="form-control"></select>
    ...
    <select name="color_id" id="color_id" class="form-control"></select>
    ...
    <select name="tipoVehiculo_id" id="tipoVehiculo_id" class="form-control"></select>
    ...
    <select name="claseVehiculo_id" id="claseVehiculo_id" class="form-control"></select>
    ...
    <select name="procedencia_id" id="procedencia_id" class="form-control"></select>

<div class="form-group">
    ...
    @else
        <input type="text" name="placa" id="placa" class="form-control" value="{{isset($vehiculo->placa)?$vehiculo->placa:''}}">
    @endif
    <br><br>
    <label for="señas">Señas: </label>
    @if ($modo == 'Ver')
        <textarea name="señas" id="señas" cols="30" rows="10" class="form-control" readonly>{{isset($vehiculo->señas)?$vehiculo->señas:''}}</textarea>
    @else
    <textarea name="señas" id="señas" cols="30" rows="10" class="form-control">{{isset($vehiculo->señas)?$vehiculo->señas:''}}</textarea>
    @endif
    <br><br>
